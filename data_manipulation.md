...
\##‘select’ Use ‘select’ to select variables
...
if wanted to move things around and put in order we want (litter number
and gd0 weight) and keep everything else same
...
dont have to say everything in this version will just have these two
variables first
...
double equal is asking if it is equal to 20 or 19. will give us filter
values we are asking for if they exist
...
first line only seeing group that has Con7 Low 7 or Low 8 in second line
...
will give us only datapoints with group Low7 or Low8 value and pups born
alive equal to 8
...
get rid of missing data. can drop NAs in everything or can drop NAs for
specific variables
...
```
    ...
    ##    litter_number   sex pd_ears pd_eyes pd_pivot pd_walk
    ##    <chr>         <dbl>   <dbl>   <dbl>    <dbl>   <dbl>
    ##  1 #1/2/95/2         2       4      13        7      10
    ##  2 #1/2/95/2         2       5      13        8      10
    ##  3 #1/2/95/2         2       5      13        8      10
    ##  4 #1/2/95/2         2       5      13        6      10
    ##  5 #5/5/3/83/3-3     2       5      13        8      10
    ##  6 #5/5/3/83/3-3     2       5      14        7      10
    ##  7 #5/5/3/83/3-3     2       5      14        8      10
    ##  8 #5/4/2/95/2       2      NA      14        7      10
...
first two lines creating new variable last line lowercasing all group
variables
